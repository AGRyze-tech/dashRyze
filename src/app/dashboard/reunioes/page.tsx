          ...
          {loading ? (
            ...
            <div>
              {filtered.map(m => {
                ...
                return (
                  <div key={m.id} className="flex items-center gap-3 px-5 py-3.5 border-b border-gray-50 dark:border-[#181819] last:border-0 hover:bg-gray-50/70 dark:hover:bg-[#181819] transition-colors group">
