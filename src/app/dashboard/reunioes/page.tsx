...
const typeConfig: Record<MeetingType, { label: string; color: 'green' | 'blue' | 'purple'; icon: React.ElementType; bgClass: string; iconClass: string; activeClass: string }> = {
  ...
  fechamento: { label: 'Fechamento', color: 'green',  icon: Handshake, bgClass: 'bg-[#01CA3C]/10 dark:bg-[#01CA3C]/20', iconClass: 'text-[#01CA3C] dark:text-[#01CA3C]',   activeClass: 'bg-[#01CA3C] dark:bg-[#014e18] text-white' },
...
const statusConfig: Record<MeetingStatus, { label: string; selectClass: string }> = {
  ...
  concluida: { label: 'Concluída', selectClass: 'bg-[#01CA3C]/10 dark:bg-[#01CA3C]/20 text-[#01CA3C] dark:text-[#01CA3C] border-[#01CA3C]/30 dark:border-[#01CA3C]/40' },
...
function Skeleton({ className }: { className?: string }) {
  return <div className={`animate-pulse rounded-lg bg-gray-100 dark:bg-[#252528] ${className}`} />
}
        ...
        <div className="p-4 sm:p-6">
          <div className="card-light p-8 flex flex-col items-center text-center gap-4 max-w-lg mx-auto">
            ...
            <div>
              ...
              <p className="text-[13px] text-gray-500 dark:text-[#01992e]">
      ...
      <div className="p-4 sm:p-6 space-y-5">
        ...
        <div className="grid grid-cols-2 xl:grid-cols-5 gap-4">
          <div className="stat-card p-5 xl:col-span-1">
            ...
            <p className="text-[11px] font-semibold uppercase tracking-widest text-gray-400 dark:text-[#017e26] mb-1">Total</p>
          ...
          <div className="stat-card p-5 xl:col-span-1">
            <div className="w-9 h-9 rounded-xl bg-[#01CA3C]/10 dark:bg-[#01CA3C]/20 flex items-center justify-center mb-3">
              <CheckCircle2 size={16} className="text-[#01CA3C] dark:text-[#01CA3C]" />
            </div>
            <p className="text-[11px] font-semibold uppercase tracking-widest text-gray-400 dark:text-[#017e26] mb-1">Concluídas</p>
            {loading ? <Skeleton className="h-7 w-12" /> : (
              <p className="text-[28px] font-bold leading-none text-[#01CA3C] dark:text-[#01CA3C]">{concluidas}</p>
            )}
          </div>

          <div className="stat-card p-5 xl:col-span-1">
            <div className="w-9 h-9 rounded-xl bg-[#01CA3C]/10 dark:bg-[#01CA3C]/20 flex items-center justify-center mb-3">
              <Handshake size={16} className="text-[#01CA3C] dark:text-[#01CA3C]" />
            </div>
            <p className="text-[11px] font-semibold uppercase tracking-widest text-gray-400 dark:text-[#017e26] mb-1">Fechamentos</p>
            {loading ? <Skeleton className="h-7 w-12" /> : (
              <p className="text-[28px] font-bold leading-none text-[#01CA3C] dark:text-[#01CA3C]">{fechamentos}</p>
            )}
          </div>
          ...
          <div className="stat-card p-5 xl:col-span-1">
            ...
            <p className="text-[11px] font-semibold uppercase tracking-widest text-gray-400 dark:text-[#017e26] mb-1">Churned</p>
            {loading ? <Skeleton className="h-7 w-12" /> : (
          ...
          <div className="stat-card p-5 xl:col-span-1">
            ...
            <p className="text-[11px] font-semibold uppercase tracking-widest text-gray-400 dark:text-[#017e26] mb-1">Taxa No-show</p>
        ...
        <div className="card-light overflow-hidden">
          <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100 dark:border-[#2a2a2e]">
            <div>
              <h3 className="text-[11px] font-semibold uppercase tracking-widest text-gray-400 dark:text-[#017e26]">Histórico</h3>
          ...
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-16 text-center">
              <div className="w-12 h-12 rounded-2xl bg-gray-100 dark:bg-[#252528] flex items-center justify-center mb-3">
                <Calendar size={18} className="text-gray-300 dark:text-[#33333a]" />
              </div>
              <p className="text-[13px] font-medium text-gray-400 dark:text-[#017e26]">Nenhuma reunião neste mês</p>
              <p className="text-[12px] text-gray-300 dark:text-[#33333a] mt-0.5">Clique em "Registrar" para adicionar</p>
            </div>
          ) : (
            <div>
              {filtered.map(m => {
                ...
                return (
                  <div key={m.id} className="flex items-center gap-3 px-5 py-3.5 border-b border-gray-50 dark:border-[#2a2a2e] last:border-0 hover:bg-gray-50/70 dark:hover:bg-[#252528] transition-colors group">
                  ...
                  return (
                    <button
                      ...
                      className={`flex-1 py-2 text-[11px] font-semibold transition-all cursor-pointer flex items-center justify-center gap-1 ${
                        form.type === type ? cfg.activeClass : 'bg-white dark:bg-[#1c1c1f] text-gray-500 dark:text-[#017e26] hover:bg-gray-50 dark:hover:bg-[#252528]'
                      }`}
                    >
