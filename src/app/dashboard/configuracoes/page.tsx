            ...
            <div className="bg-white rounded-xl border border-gray-200 divide-y divide-gray-100">
              {profiles.map(profile => (
                <div key={profile.id} className="flex items-center gap-4 px-5 py-4">
                  <div className="w-9 h-9 rounded-full bg-[#00FF41] flex items-center justify-center text-white text-sm font-bold flex-shrink-0">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      {profile.id === currentUser?.id && (
                        <span className="text-[10px] font-medium bg-[#F0FBF5] text-[#00FF41] px-2 py-0.5 rounded-full">
                          Você
                        </span>
                      )}
                    </div>
                  ...
                  {profile.id !== currentUser?.id ? (
                    <select
                      ...
                      className="text-[13px] border border-gray-200 rounded-lg px-3 py-1.5 focus:outline-none focus:border-[#00FF41] bg-white cursor-pointer"
                    >
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-5 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 text-sm border border-gray-200 rounded-lg focus:outline-none focus:border-[#00FF41] focus:ring-2 focus:ring-[#00FF41]/10"
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 text-sm border border-gray-200 rounded-lg focus:outline-none focus:border-[#00FF41] bg-white"
              >
                <option value="gerente">Gerente</option>
                <option value="visualizador">Visualizador</option>
              </select>
