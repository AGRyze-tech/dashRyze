              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-3 space-y-2 max-h-52 overflow-y-auto">
                {dueDates.map((date, i) => (
                  <div key={i} className="flex items-center gap-3">
                    <div className="w-6 h-6 rounded-full bg-[#32B86A]/10 flex items-center justify-center flex-shrink-0">
                      <span className="text-[10px] font-bold text-[#32B86A]">{i + 1}</span>
                    </div>
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <input type="date"
                        className="text-[12px] border border-gray-200 rounded-md px-2 py-1 text-gray-600 focus:outline-none focus:ring-1 focus:ring-[#32B86A] bg-white"
                        value={date}
                        onChange={e => {
                          const next = [...dueDates]
