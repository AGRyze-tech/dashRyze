              ...
              return (
                <div key={key} className="py-3 text-center border-r border-gray-100 dark:border-[#2a2a2a] last:border-r-0">
                  ...
                  <div className={cn(
                    ...
                    isToday
                      ? 'bg-[#32B86A] text-white shadow-[0_0_12px_rgba(78,232,138,0.4)]'
      ...
      >
        <form onSubmit={handleSave} className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label htmlFor="ag-client" className="block text-[12px] font-medium text-gray-700 dark:text-[#3E9E60] mb-1.5">Cliente / Contato *</label>
              <input id="ag-client" className="input-field" placeholder="Dr. Nome..." value={form.client_name} onChange={set('client_name')} required />
            </div>

            <div>
              <label htmlFor="ag-date" className="block text-[12px] font-medium text-gray-700 dark:text-[#3E9E60] mb-1.5">Data *</label>
              <input id="ag-date" type="date" className="input-field" value={form.date} onChange={set('date')} required />
            </div>

            <div>
              <label htmlFor="ag-time" className="block text-[12px] font-medium text-gray-700 dark:text-[#3E9E60] mb-1.5">Horário</label>
              <input id="ag-time" type="time" className="input-field" value={form.scheduled_time} onChange={set('scheduled_time')} />
            </div>

            <div>
              <label htmlFor="ag-status" className="block text-[12px] font-medium text-gray-700 dark:text-[#3E9E60] mb-1.5">Status</label>
            ...
            <div className="col-span-2">
              <label htmlFor="ag-notes" className="block text-[12px] font-medium text-gray-700 dark:text-[#3E9E60] mb-1.5">Observações</label>
      ...
      <Modal isOpen={!!deleteTarget && !showModal} onClose={() => setDeleteTarget(null)} title="Remover Reunião" size="sm">
        {deleteTarget && (
          <div className="space-y-4">
            <p className="text-sm text-gray-600 dark:text-[#3E9E60]">
