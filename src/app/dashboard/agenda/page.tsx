      ...
      <div className="p-4 sm:p-6 space-y-4">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-1.5">
            <button
              onClick={goToday}
              className="px-3 py-1.5 rounded-lg text-[12px] font-semibold border border-gray-200 dark:border-[#28282d] text-gray-600 dark:text-[#00a02a] hover:bg-gray-50 dark:hover:bg-[#181819] transition-colors"
            >
              Hoje
            </button>
            <button
              ...
              className="p-1.5 rounded-lg border border-gray-200 dark:border-[#28282d] text-gray-500 dark:text-[#00a02a] hover:bg-gray-50 dark:hover:bg-[#181819] transition-colors"
            >
              <ChevronLeft size={16} />
            </button>
            <button
        ...
        <div className="card-light overflow-hidden">
          ...
          <div className="grid border-b border-gray-100 dark:border-[#181819]" style={{ gridTemplateColumns: '52px repeat(7, 1fr)' }}>
            <div className="border-r border-gray-100 dark:border-[#181819]" />
            {days.map(day => {
              ...
              return (
                <div key={key} className="py-3 text-center border-r border-gray-100 dark:border-[#181819] last:border-r-0">
                  ...
                  <div className={cn(
                    ...
                    isToday
                      ? 'bg-[#00FF41] text-white shadow-[0_0_12px_rgba(78,232,138,0.4)]'
            ...
            return (
              <div className="grid border-b border-gray-100 dark:border-[#181819]" style={{ gridTemplateColumns: '52px repeat(7, 1fr)' }}>
                ...
                {days.map(day => {
                  ...
                  return (
                    <div key={key} className="px-1 py-1.5 min-h-[32px] border-r border-gray-100 dark:border-[#181819] last:border-r-0 flex flex-wrap gap-1">
                      {allDay.map(m => {
          ...
          >
            {/* Time labels */}
            <div className="relative border-r border-gray-100 dark:border-[#181819]" style={{ height: GRID_H }}>
            ...
            {days.map(day => {
              ...
              return (
                <div
                  key={key}
                  className="relative border-r border-gray-100 dark:border-[#181819] last:border-r-0 cursor-pointer hover:bg-gray-50/40 dark:hover:bg-[#181819]/40 transition-colors"
                  style={{ height: GRID_H }}
                  ...
                  {Array.from({ length: SLOTS }).map((_, i) => (
                    <div
                      ...
                      className={cn(
                        ...
                        i % 2 === 0
                          ? 'border-t border-gray-100 dark:border-[#181819]'
                          : 'border-t border-dashed border-gray-50 dark:border-[#181819]'
                      )}
                      style={{ top: i * SLOT_H }}
                    />
                  ))}
        ...
        <form onSubmit={handleSave} className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="col-span-2">
              <label className="block text-[12px] font-medium text-gray-700 dark:text-[#00a02a] mb-1.5">Tipo *</label>
            ...
            <div>
              <label htmlFor="ag-date" className="block text-[12px] font-medium text-gray-700 dark:text-[#00a02a] mb-1.5">Data *</label>
              <input id="ag-date" type="date" className="input-field" value={form.date} onChange={set('date')} required />
            </div>

            <div>
              <label htmlFor="ag-time" className="block text-[12px] font-medium text-gray-700 dark:text-[#00a02a] mb-1.5">Horário</label>
              <input id="ag-time" type="time" className="input-field" value={form.scheduled_time} onChange={set('scheduled_time')} />
            </div>

            <div>
              <label htmlFor="ag-status" className="block text-[12px] font-medium text-gray-700 dark:text-[#00a02a] mb-1.5">Status</label>
            ...
            <div className="col-span-2">
              <label htmlFor="ag-notes" className="block text-[12px] font-medium text-gray-700 dark:text-[#00a02a] mb-1.5">Observações</label>
      ...
      <Modal isOpen={!!deleteTarget && !showModal} onClose={() => setDeleteTarget(null)} title="Remover Reunião" size="sm">
        {deleteTarget && (
          <div className="space-y-4">
            <p className="text-sm text-gray-600 dark:text-[#00a02a]">
