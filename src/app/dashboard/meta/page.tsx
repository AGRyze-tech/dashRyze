      ...
      <div className="p-4 sm:p-6 space-y-5">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
          {[
            ...
            { label: 'Cliques', value: totalClicks.toLocaleString('pt-BR'), icon: MousePointer, iconCls: 'text-[#32B86A] dark:text-[#4EE88A]', bgCls: 'bg-[#32B86A]/10 dark:bg-[#32B86A]/20' },
                ...
                {campaigns.length === 0 ? (
                  ...
                  <ResponsiveContainer width="100%" height={220}>
                    <BarChart data={spendData} margin={{ top: 4, right: 16, left: -16, bottom: 0 }}>
                      ...
                      <Bar dataKey="spend" name="Gasto" fill="#32B86A" radius={[5, 5, 0, 0]} maxBarSize={40} />
                    </BarChart>
                  </ResponsiveContainer>
                )}
              </div>
