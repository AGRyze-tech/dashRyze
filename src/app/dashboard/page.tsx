...
function Skeleton({ className }: { className?: string }) {
  return <div className={`animate-pulse motion-reduce:animate-none rounded-lg bg-gray-100 dark:bg-[#181819] ${className}`} />
}
...
function textColor(p: number) {
  if (p >= 100) return 'text-[#00FF41] dark:text-[#00FF41]'
    ...
    <div className="space-y-2.5">
      <div className="flex items-center justify-between gap-3">
        <div className="flex items-center gap-2 min-w-0">
          ...
          {done && (
            <span className="inline-flex items-center gap-0.5 text-[10px] font-bold px-1.5 py-0.5 rounded-full bg-[#00FF41]/10 dark:bg-[#00FF41]/20 text-[#00FF41] dark:text-[#00FF41] flex-shrink-0">
      ...
      {/* Bar */}
      <div className="relative h-2.5 bg-gray-100 dark:bg-[#181819] rounded-full overflow-hidden">
        <div
          ref={barRef}
    ...
    <div className="card-light p-5">
      <div className="flex items-center justify-between mb-5">
        ...
        <div className="w-9 h-9 rounded-xl bg-[#00FF41]/10 dark:bg-[#00FF41]/20 flex items-center justify-center">
          <Target size={16} className="text-[#00FF41] dark:text-[#00FF41]" />
        </div>
      </div>
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="flex items-center gap-2">
        ...
        />
        <button type="button" onClick={onCommit} className="h-9 px-3 rounded-lg bg-[#00FF41] hover:bg-[#003810] text-white text-[12px] font-medium flex items-center gap-1.5 transition-colors flex-shrink-0">
          <Check size={12} /> Salvar
        </button>
        <button type="button" onClick={onCancel} aria-label="Cancelar edição" className="h-9 px-2.5 rounded-lg border border-gray-200 dark:border-[#28282d] hover:bg-gray-50 dark:hover:bg-[#181819] text-gray-500 dark:text-[#00a02a] transition-colors flex-shrink-0">
...
function DeadlineRow({ project }: { project: DashProject }) {
  ...
  return (
    <div className="flex items-center gap-3 px-5 py-3 border-b border-gray-50 dark:border-[#181819] last:border-0 hover:bg-gray-50/60 dark:hover:bg-[#181819] transition-colors">
...
function LeadRow({ lead }: { lead: Lead }) {
  ...
  return (
    <div className="flex items-center gap-3 px-5 py-3 border-b border-gray-50 dark:border-[#181819] last:border-0 hover:bg-gray-50/60 dark:hover:bg-[#181819] transition-colors">
      <div className="w-8 h-8 rounded-full bg-[#F0FBF5] dark:bg-[#001c08] flex items-center justify-center shrink-0">
        <span className="text-[11px] font-bold text-[#00FF41] dark:text-[#00FF41]">{initials}</span>
      </div>
      <div className="flex-1 min-w-0">
    ...
    <div className={`stat-card p-5 overflow-hidden relative group ${href ? 'cursor-pointer' : ''}`}>
      ...
      {loading ? (
        ...
        <>
          ...
          {sub && <p className="text-[11px] text-gray-400 dark:text-[#00a02a]">{sub}</p>}
        </>
      )}
    </div>
  )
      ...
      <div className="p-4 sm:p-6 space-y-5">
        ...
        <div className="grid grid-cols-2 xl:grid-cols-4 gap-4 stagger-children">
          ...
          <KpiCard
            ...
            icon={Users}
            iconCls="bg-[#F0FBF5] dark:bg-[#001c08] text-[#00FF41] dark:text-[#00FF41]"
            accent="from-[#00FF41]/5"
            loading={loading}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
          <div className="lg:col-span-2 card-light p-5 flex flex-col gap-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                {loading ? (
                  ...
                  <p className={`tabular text-[28px] font-bold leading-none mt-1 ${balance >= 0 ? 'text-[#00FF41] dark:text-[#00FF41]' : 'text-red-500 dark:text-red-400'}`}>
                    {formatCurrency(balance)}
                  </p>
                )}
              </div>
              <div className={`w-11 h-11 rounded-xl flex items-center justify-center ${balance >= 0 ? 'bg-[#00FF41]/10 dark:bg-[#00FF41]/20' : 'bg-red-50 dark:bg-red-900/20'}`}>
                <Wallet size={18} className={balance >= 0 ? 'text-[#00FF41] dark:text-[#00FF41]' : 'text-red-500 dark:text-red-400'} />
              </div>
            </div>
            ...
            <Link href="/dashboard/financeiro" className="flex items-center justify-between text-[12px] font-medium text-[#00FF41] dark:text-[#00FF41] hover:opacity-80 transition-opacity mt-auto pt-1 border-t border-gray-100 dark:border-[#181819]">
          ...
          <div className="lg:col-span-3 card-light p-5">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link href="/dashboard/meta" className="flex items-center gap-1 text-[11px] font-medium text-[#00FF41] dark:text-[#00FF41] hover:opacity-80 transition-opacity">
            ...
            {meta.length === 0 ? (
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                {[
                  ...
                  { label: 'Cliques', value: metaClicks >= 1000 ? `${(metaClicks / 1000).toFixed(1)}k` : String(metaClicks), icon: MousePointer, cls: 'text-[#00FF41] dark:text-[#00FF41] bg-[#F0FBF5] dark:bg-[#001c08]' },
                  ...
                  <div key={label} className="bg-gray-50/80 dark:bg-[#181819] rounded-xl p-3.5">
        ...
        <div className="card-light overflow-hidden">
          <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100 dark:border-[#181819]">
            ...
            <Link href="/dashboard/projetos" className="flex items-center gap-1 text-[11px] font-medium text-[#00FF41] dark:text-[#00FF41] hover:opacity-80 transition-opacity">
